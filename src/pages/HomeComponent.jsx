                ...
                <div className="flex items-center gap-4">
                    <IconButton onClick={() => navigate("/history")}>
                       ...
                       <div className="hidden md:block p-px rounded-full bg-linear-to-b from-white to-white/60">
                        ...
                        className="bg-indigo-500 hover:bg-indigo-600 text-white text-sm tracking-wide px-4 py-2 rounded-full transition"
                    >
                        Logout
                    </button>
                       </div>
  ...
  <div className="flex flex-col-reverse md:flex-row items-center gap-12">
    ...
    <div className="w-full md:w-1/2 text-center md:text-left">
      ...
      >
        ...
        <button
          type="submit"
          className="bg-indigo-500 hover:bg-indigo-600 text-white text-md  cursor-pointer px-6 py-2 rounded-full transition"
        >
          Join
        </button>
      </form>
